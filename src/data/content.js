...
export const achievements = [
  {
    ...
    description: 'Hackathons, workshops, coding contests, and collaborative build sessions.',
  },
  {
    value: 320,
    suffix: '+',
    label: 'Active Members',
    description: 'A diverse student community across domains and experience levels.',
  },
  {
    value: 68,
    suffix: '+',
...
export const membershipPillars = [
  {
    title: 'Benefits',
    points: [
      'Access to technical resources, mentorship, and curated opportunities.',
      'Advance your career through projects, showcases, and peer collaboration.',
      'Participate in conferences, coding challenges, and expert sessions.',
    ],
  },
  {
    title: 'Join A Society',
    points: [
      'Stay updated with modern technology trends and tools.',
      'Network with students, faculty, and professionals in tech.',
      'Collaborate on impactful projects and research-oriented initiatives.',
    ],
  },
  {
    title: 'Join IETE',
    points: [
      'Be part of one of the largest global technology communities.',
      'Learn with professionals and experts shaping the future of engineering.',
      'Build practical skills and accelerate your professional development.',
    ],
  },
]
...
export const gallery = [
  {
    ...
    alt: 'Students discussing ideas during a workshop',
  },
  {
  ...
  },
  {
    ...
    alt: 'Code displayed on a monitor in a dark room',
  },
  {
  ...
  },
  {
    ...
    alt: 'Electronics and robotics setup on table',
  },
  {
    src: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=900&q=80',
    alt: 'Group discussing a product roadmap on whiteboard',
  },
]
...
export const testimonials = [
  {
    quote:
      'IETE gave me my first real team project experience. I learned product thinking, code quality, and presentation confidence in one place.',
    name: 'Anushka Sen',
    title: 'Frontend Domain Lead',
  },
  {
    quote:
      'The workshops and peer mentorship helped me move from beginner to problem-solver. The culture is ambitious and supportive.',
    name: 'Ritvik Ghosh',
    title: 'Competitive Programming Member',
  },
  {
    quote:
      'Our hackathon team met through IETE sessions. We built a working prototype and presented it to mentors in just 24 hours.',
    name: 'Sanjana Roy',
